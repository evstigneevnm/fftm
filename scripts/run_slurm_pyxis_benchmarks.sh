...
FFTM_BINARY_EXTRA_ARGS="${FFTM_BINARY_EXTRA_ARGS:-}"
FFTM_4D_BINARY_EXTRA_ARGS="${FFTM_4D_BINARY_EXTRA_ARGS:-}"
...
FFTM_4D_NATIVE_XW_DIRECT_LAYOUTS="${FFTM_4D_NATIVE_XW_DIRECT_LAYOUTS:-configured}"
FFTM_4D_NATIVE_XW_PROTOCOLS="${FFTM_4D_NATIVE_XW_PROTOCOLS:-configured}"
FFTM_4D_NATIVE_XW_CHUNK_MIB="${FFTM_4D_NATIVE_XW_CHUNK_MIB:-512}"
FFTM_4D_NATIVE_XW_CHUNK_WINDOWS="${FFTM_4D_NATIVE_XW_CHUNK_WINDOWS:-configured}"
FFTM_4D_NATIVE_XW_COMPACT_STAGINGS="${FFTM_4D_NATIVE_XW_COMPACT_STAGINGS:-configured}"
FFTM_4D_SLAB_NATIVE_WORK_AREA_ALIASES="${FFTM_4D_SLAB_NATIVE_WORK_AREA_ALIASES:-configured}"
FFTM_4D_SLAB_NATIVE_WZ_COMM_LAYOUTS="${FFTM_4D_SLAB_NATIVE_WZ_COMM_LAYOUTS:-configured}"
FFTM_4D_SLAB_NATIVE_WZ_PLAN_CONCURRENCIES="${FFTM_4D_SLAB_NATIVE_WZ_PLAN_CONCURRENCIES:-configured}"
FFTM_4D_SLAB_NATIVE_WZ_READY_PIPELINES="${FFTM_4D_SLAB_NATIVE_WZ_READY_PIPELINES:-configured}"
FFTM_4D_PENCIL_SAME_ZW_PEER_PAIRED="${FFTM_4D_PENCIL_SAME_ZW_PEER_PAIRED:-configured}"
FFTM_4D_PENCIL_SAME_ZW_NATIVE_LAYOUTS="${FFTM_4D_PENCIL_SAME_ZW_NATIVE_LAYOUTS:-configured}"
FFTM_4D_PENCIL_DEGENERATE_XW_SLAB_PATHS="${FFTM_4D_PENCIL_DEGENERATE_XW_SLAB_PATHS:-configured}"
FFTM_4D_PENCIL_DEGENERATE_LOCAL_TRANSPOSES="${FFTM_4D_PENCIL_DEGENERATE_LOCAL_TRANSPOSES:-configured}"
FFTM_4D_PENCIL_DEGENERATE_SAME_XW_NATIVE="${FFTM_4D_PENCIL_DEGENERATE_SAME_XW_NATIVE:-configured}"
FFTM_4D_PENCIL_DEGENERATE_WZ_SLICED_Z_FFT="${FFTM_4D_PENCIL_DEGENERATE_WZ_SLICED_Z_FFT:-configured}"
FFTM_4D_PENCIL_NODE_ALIGNED_WZ_PIPELINES="${FFTM_4D_PENCIL_NODE_ALIGNED_WZ_PIPELINES:-${FFTM_4D_PENCIL_P3_DEGENERATE_WZ_PIPELINES:-configured}}"
FFTM_4D_PENCIL_GRID_ORIENTATIONS="${FFTM_4D_PENCIL_GRID_ORIENTATIONS:-configured}"
...
args=(
    ...
    "--fftm-binary-extra-args=${FFTM_BINARY_EXTRA_ARGS}"
    "--fftm-4d-binary-extra-args=${FFTM_4D_BINARY_EXTRA_ARGS}"
    ...
    --fftm-4d-pencil-grid-orientations "${FFTM_4D_PENCIL_GRID_ORIENTATIONS}"
    ...
    --fftm-4d-native-xw-direct-layouts "${FFTM_4D_NATIVE_XW_DIRECT_LAYOUTS}"
    --fftm-4d-native-xw-protocols "${FFTM_4D_NATIVE_XW_PROTOCOLS}"
    --fftm-4d-native-xw-chunk-mib "${FFTM_4D_NATIVE_XW_CHUNK_MIB}"
    --fftm-4d-native-xw-chunk-windows "${FFTM_4D_NATIVE_XW_CHUNK_WINDOWS}"
    --fftm-4d-native-xw-compact-stagings "${FFTM_4D_NATIVE_XW_COMPACT_STAGINGS}"
    --fftm-4d-slab-native-work-area-aliases "${FFTM_4D_SLAB_NATIVE_WORK_AREA_ALIASES}"
    --fftm-4d-slab-native-wz-communication-layouts "${FFTM_4D_SLAB_NATIVE_WZ_COMM_LAYOUTS}"
    --fftm-4d-slab-native-wz-plan-concurrencies "${FFTM_4D_SLAB_NATIVE_WZ_PLAN_CONCURRENCIES}"
    --fftm-4d-slab-native-wz-ready-pipelines "${FFTM_4D_SLAB_NATIVE_WZ_READY_PIPELINES}"
    --fftm-4d-pencil-same-zw-peer-paired "${FFTM_4D_PENCIL_SAME_ZW_PEER_PAIRED}"
    --fftm-4d-pencil-same-zw-native-layouts "${FFTM_4D_PENCIL_SAME_ZW_NATIVE_LAYOUTS}"
    --fftm-4d-pencil-degenerate-xw-slab-paths "${FFTM_4D_PENCIL_DEGENERATE_XW_SLAB_PATHS}"
    --fftm-4d-pencil-degenerate-local-transposes "${FFTM_4D_PENCIL_DEGENERATE_LOCAL_TRANSPOSES}"
    --fftm-4d-pencil-degenerate-same-xw-native "${FFTM_4D_PENCIL_DEGENERATE_SAME_XW_NATIVE}"
    --fftm-4d-pencil-degenerate-wz-sliced-z-fft "${FFTM_4D_PENCIL_DEGENERATE_WZ_SLICED_Z_FFT}"
    --fftm-4d-pencil-p3-degenerate-wz-pipelines "${FFTM_4D_PENCIL_NODE_ALIGNED_WZ_PIPELINES}"
