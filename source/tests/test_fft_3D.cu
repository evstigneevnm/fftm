...
int main(int argc, char const *argv[])
{
    ...
    fft.template add_plan_3D<fftm::direction::R2C>(
        "3D_r2c",
        static_cast<long long int>(Nx),
        static_cast<long long int>(Ny),
        static_cast<long long int>(Nz),
        static_cast<long long int>(Nx),
        static_cast<long long int>(Ny),
        static_cast<long long int>(Nz),
        1,
        static_cast<long long int>(Nx * Ny * Nz),
        static_cast<long long int>(Nx),
        static_cast<long long int>(Ny),
        static_cast<long long int>(Nz_C),
        1,
        static_cast<long long int>(Nx * Ny * Nz_C),
        1);
